            ...
            <div className="eficiencia__bottom">
                <div className="eficiencia__bottomContainer">
                    ...
                    <div className="eficiencia__bottomColumn eficiencia__bottomCol2">
                        <h3 className="eficiencia__body">Los paneles de construcción SIP que utilizamos en Nokk preservan la energía, ahorrando más del 60%, solo por la conservación del calor.</h3>
                    </div>
                </div>
                <div className="eficiencia__buttonContainer">
                    <button className="eficiencia__button">CONTACTANOS</button>
                </div>
            </div>
